...
impl Setting {
    ...
    pub const ALL: &'static [Setting] = &[
        ...
        Setting::VimCtrlKeys,
        Setting::VimSaveKey,
        Setting::VimClipboard,
        Setting::VimHlsearch,
        Setting::VimIgnorecase,
        Setting::VimSmartcase,
    ...
    pub fn section(self) -> &'static str {
        ...
        match self {
            ...
            VimEnabled | VimCtrlKeys | VimSaveKey | VimClipboard | VimHlsearch | VimIgnorecase | VimSmartcase => "VIM",
    ...
    pub fn label(self) -> &'static str {
        ...
        match self {
            ...
            VimEnabled => "Vim mode",
            VimCtrlKeys => "Vim's Ctrl keys beat the shortcuts",
            VimSaveKey => "The save shortcut works too, not only :w",
            VimClipboard => "Yank and put use the clipboard",
            VimHlsearch => "Highlight search matches",
            VimIgnorecase => "Search ignores case",
            VimSmartcase => "Unless the pattern has capitals",
    ...
    pub fn is_on(self, cfg: &Config) -> bool {
        ...
        match self {
            ...
            VimEnabled => cfg.vim.enabled,
            VimCtrlKeys => cfg.vim.ctrl_keys,
            VimSaveKey => cfg.vim.save_key,
            VimClipboard => cfg.vim.clipboard,
            VimHlsearch => cfg.vim.hlsearch,
            VimIgnorecase => cfg.vim.ignorecase,
            VimSmartcase => cfg.vim.smartcase,
            _ => false,
        }
    }
    ...
    pub fn step(self, cfg: &mut Config, delta: i32) {
        ...
        match self {
            ...
            VimEnabled => cfg.vim.enabled = !cfg.vim.enabled,
            VimCtrlKeys => cfg.vim.ctrl_keys = !cfg.vim.ctrl_keys,
            VimSaveKey => cfg.vim.save_key = !cfg.vim.save_key,
            VimClipboard => cfg.vim.clipboard = !cfg.vim.clipboard,
            VimHlsearch => cfg.vim.hlsearch = !cfg.vim.hlsearch,
            VimIgnorecase => cfg.vim.ignorecase = !cfg.vim.ignorecase,
            VimSmartcase => cfg.vim.smartcase = !cfg.vim.smartcase,
